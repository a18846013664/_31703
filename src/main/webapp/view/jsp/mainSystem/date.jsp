...
<div style="width: 100%;height: 45px;background: #176fc6">
    <form action="/b/outdate" method="post" style="position: absolute;top: 5px;left: 450px">
        ...
        <input  type="text" name="outdate" value="" style="width: 450px;height: 30px;border-radius:15px ">
    </form>
...
<div class="as" style="overflow-x: hidden;overflow-y: scroll;opacity: 0.9;height: 500px;width: 1350px" >
    <div id="a1">
        <table width="1335px">
            ...
            <c:forEach var="outdates" items="${outdate}" >
                <tr>
                    <td style="background: #d2e6eb;font-weight: bolder;opacity: 0.8;border: 25px"><div style="text-align: center">${outdates.username}</div></td>
                    <td style="background: #e2e2e2;font-weight: bolder;opacity: 0.8;border: 25px"><div style="text-align: center">${outdates.phone}</div></td>
                    <td style="background: #e2e2e2;font-weight: bolder;opacity: 0.8;border: 25px"><div style="text-align: center">${outdates.card}</div></td>
                    <td style="background: #e2e2e2;font-weight: bolder;opacity: 0.8;border: 25px"><div style="text-align: center">${outdates.rnumber}</div></td>
                    <td style="background: #e2e2e2;font-weight: bolder;opacity: 0.8;border: 25px"><div style="text-align: center">${outdates.date}</div></td>
                    <td style="background: #e2e2e2;font-weight: bolder;opacity: 0.8;border: 25px"><div style="text-align: center"><a style="color: black" href="/b/reset?id=${outdates.id}&rnumber=${outdates.id}">退订</a></div></td>
                </tr>
            </c:forEach>
        </table>
    </div>
