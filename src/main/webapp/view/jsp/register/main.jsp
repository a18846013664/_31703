...
<body>
    ...
    <div style="height: 500px;width: 1360px;background: gray;margin: 0 auto">
        ...
        <div style="width: 1100px;height: 500px;background: #4c4c4c;position: absolute;top: 49px;right:88px">
            <div id="ac">
                <table
            ...
            style="border-radius: 15px;position: absolute;top:40px;left: 150px;background: white;width: 780px;height: 400px;overflow: hidden;">
                ...
                <form action="/a/updatefile" method="post" enctype="multipart/form-data">
                    ...
                    <input disabled="disabled" type="submit" value="上传"
                        style="background-color: sandybrown;position: absolute;top: 300px;left: 300px;font-size: 20px; bolder;border: none;border-radius: 15px;width: 70px;"
                        id="submit">
                </form>
            </div>
    ...
    <div class="footer">
        ...
        <div class="footer-1">
            <h3>联系我们</h3>
            <span><a href="#"><img src="images/qq1.1.png"></a></span>
            <span><a href="#"><img src="images/weibo1.1.png"></a></span>
            <span><a href="#"><img src="images/facebook1.1.png"></a></span>
            <span><a href="#"><img src="images/twitter1.1.png"></a></span>
        </div>
    </div>
